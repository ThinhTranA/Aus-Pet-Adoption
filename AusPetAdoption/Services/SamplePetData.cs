    ...
    public static class SamplePetData
    {
        ...
        static SamplePetData()
        {
            ...
            Pets.Add(new Pet
            {
                ...
                PetType = "Dog", 
                Breed = "Affenpinscher",
                ImageUrl = "https://en.wikipedia.org/wiki/Affenpinscher#/media/File:Affenpinscher.jpg",
            ...
            Pets.Add(new Pet
            {
                ...
                PetType = "Dog",
                Breed = "Basset Hound",
                ImageUrl = "https://en.wikipedia.org/wiki/Basset_Hound#/media/File:BassetHound_profil.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
            ...
            Pets.Add(new Pet
            {
                ...
                ImageUrl = "https://en.wikipedia.org/wiki/Oriental_bicolour#/media/File:Oriental_shorthair_20070130_caroline.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
            ...
            Pets.Add(new Pet
            {
                ...
                ImageUrl = "https://en.wikipedia.org/wiki/Caucasian_Shepherd_Dog#/media/File:Owczarek_kaukaski_65.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
            ...
            Pets.Add(new Pet
            {
                ...
                PetType = "Dog",
                Breed = "Cursinu",
                ImageUrl = "https://en.wikipedia.org/wiki/Cursinu#/media/File:Cursinu_1.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
            ...
            Pets.Add(new Pet
            {
                ...
                ImageUrl = "https://en.wikipedia.org/wiki/Californian_rabbit#/media/File:Kr%C3%B3liki_kalifornijskie_californian_rabbits.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
            ...
            Pets.Add(new Pet
            {
                ...
                PetType = "Cat",
                Breed = "Suphalak",
                ImageUrl = "https://en.wikipedia.org/wiki/Suphalak#/media/File:Suphalak_Female_in_Thailand_named_AumDaengManee.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
            ...
            Pets.Add(new Pet
            {
                ...
                Breed = "Belgian Hare",
                ImageUrl = "https://en.wikipedia.org/wiki/Belgian_Hare#/media/File:Hasenkaninchen.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
            ...
            Pets.Add(new Pet
            {
                ...
                PetType = "Cat",
                Breed = "Selkirk Rex",
                ImageUrl = "https://en.wikipedia.org/wiki/Selkirk_Rex#/media/File:PolloSelkirkRex.jpg",
                DateOfBirth = DateTime.UtcNow.AddDays(-new Random().Next(1000)),
                Size = sizes.Random(),
                Location = "",
            });
